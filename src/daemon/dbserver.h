...
private:
    ...
    void processReload(ClientJsonStream *stream, JsonDbOwner *owner, int id);
    void processTerminate(ClientJsonStream *stream, JsonDbOwner *owner, const QString &partitionName, int id);
