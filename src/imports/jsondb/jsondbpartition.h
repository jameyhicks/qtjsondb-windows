...
public:
    ...
    Q_INVOKABLE QtJsonDb::JsonDbNotify* createNotification(const QString &query);

    Q_INVOKABLE QtJsonDb::JsonDbQueryObject* createQuery(const QString &query, int limit, QVariantMap bindings);
